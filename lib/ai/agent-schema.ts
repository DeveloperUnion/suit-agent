      ...
      "そもそも扱えない話題は、相手を絞っても答えられない。聞き返さず「できません」と答える。",
    {
      ...
      options: {
        ...
        description:
          ...
          "**中身を推測して選ばせないこと。**選択肢にできるのは「どちらの人か」「どの項目か」の" +
          "ように**すでに分かっている候補**だけで、聞いていない事実を言い換えて並べるのは不可" +
          "（「広背筋が発達している」「広背筋が大きい」のような、こちらで作った言い回しの二択）。" +
          "続きが聞き取れなかっただけなら、この道具を使わず、返答でそのまま聞き直す。" +
