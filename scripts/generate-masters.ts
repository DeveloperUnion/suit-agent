/**
 * 採寸マスタの SQL を lib/constants から生成する。
 *
...
console.log(
  `supabase/masters.sql を生成しました: ` +
    `item_types ${ITEM_TYPES.length} / measurement_fields ${MEASUREMENT_FIELDS.length} / adjustment_masters ${ADJUSTMENT_MASTERS.length}`,
);
